...
export class MoonsComponent implements OnInit {
  ...
  moons: Moon[] = [
    { _id: 1, name:'Encélado',planetaMae: 'Saturno', semieixoMaior: '237948', pressaoAtmosferica: 'Vestígios; assimétrica', massa: 1081020, periodoDeRotacao: '1d 8h 53min 7s (rotação síncrona)', periodoOrbital: '1370218d', inclinacao: '0019', velocidadeOrbitalMedia: 1264 }
  ]
